...
## 📊 حالة المشروع (2026-09-11 — v8.6.0)

| المجال | الحالة |
|---|---|
| الحزمة | `com.elwataniatv.app` (namespace + applicationId) ✅ |
| إصدار v8.6.0 | تشغيل الأرشيف داخل التطبيق، استئناف المشاهدة، قسم «تابع المشاهدة»، تحسين RTL وأهداف اللمس، fallback واضح لفيديو YouTube، ولوحة تحكم متجاوبة — راجع `docs/RELEASE_NOTES_V8.6.0_AR.md` ✅ |
